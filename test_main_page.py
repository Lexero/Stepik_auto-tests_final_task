...
class TestLoginFromMainPage:
    def test_guest_can_go_to_login_page(self, browser):   # Тест перехода на страницу логина
    ...
    def test_guest_should_see_login_link(self, browser):  # Тест на наличие кнопки логина
...
def test_guest_cant_see_product_in_basket_opened_from_main_page(browser):  # Тест перехода в корзину, корзина пустая
